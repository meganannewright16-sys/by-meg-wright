    ...
    <div style={{ minHeight: '100vh', fontFamily: "'Libre Franklin', sans-serif", color: '#3B2A1F' }}>
      ...
      <main className="fade-in" style={{ maxWidth: 660, margin: '0 auto', padding: '3rem 1.5rem 4rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 700, color: '#3B2A1F', margin: 0 }}>About</h2>
        </div>
        ...
        <div style={{ fontSize: '0.95rem', lineHeight: 1.85, color: '#5C4D40' }}>
          ...
          <p style={{ marginTop: '1.25rem', fontFamily: "'Playfair Display', serif", fontSize: '1.1rem', color: '#4A3728', fontWeight: 600 }}>I don't just write content. I engineer communication that performs.</p>
        </div>

        <div style={{ marginTop: '2.5rem', padding: '1.75rem', background: 'rgba(255,255,255,0.55)', borderRadius: 16, border: '1px solid #E0D5C8' }}>
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.15rem', fontWeight: 600, color: '#5C4033', marginBottom: '1rem' }}>Education</h3>
        ...
        <div style={{ marginTop: '1.25rem', padding: '1.75rem', background: 'rgba(255,255,255,0.55)', borderRadius: 16, border: '1px solid #E0D5C8' }}>
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.15rem', fontWeight: 600, color: '#5C4033', marginBottom: '1rem' }}>Tools & Platforms</h3>
        ...
        <div style={{ marginTop: '1.25rem', padding: '1.75rem', background: 'linear-gradient(135deg, rgba(107,138,94,0.06), rgba(140,168,128,0.06))', borderRadius: 16, border: '1px solid #E0D5C8', borderLeft: '3px solid #6B8A5E' }}>
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.15rem', fontWeight: 600, color: '#5C4033', marginBottom: '1rem' }}>Beyond the work</h3>
